            ...
            <div class="appear-animation" data-appear-animation="fadeInRightShorter"
                ...
                <span
                    class="badge bg-gradient-light-primary-rgba-20 text-secondary rounded-pill text-uppercase font-weight-semibold text-2-5 px-3 py-2 px-4 mb-4"><span
                        class="d-inline-flex py-1 px-2">Expertise</span></span>
            </div>
            <div class="appear-animation" data-appear-animation="fadeInUpShorter"
                data-appear-animation-delay="200">
                <h2 class="text-9 text-lg-12 font-weight-semibold line-height-1 mb-4">To Make uPVC &
                    Aluminum Windows & Doors</h2>
            </div>
            <div class="appear-animation" data-appear-animation="fadeInUpShorter"
                data-appear-animation-delay="400">
                <p>SHINER MACHINERY has been built on engineering excellence crafted through immense
                    dedication, innovation and a constant objective to serve the global market & a decade
                    young industry expertise.</p>
            </div>
            <div class="appear-animation" data-appear-animation="fadeInUpShorter"
            ...
            <div class="accordion accordion-modern-status accordion-modern-status-arrow accordion-modern-status-arrow-dark"
                ...
                <div class="card card-default box-shadow-8 border-radius-2 bg-light">
                    ...
                    <div id="collapseWhyChooseUsOne" class="collapse"
                        ...
                        <div class="card-body pt-0">
                            <ul>
                                <li><p class="mb-0">15 Months Quality Warranty</p></li>
                                <li><p class="mb-0">Life Time Free Maintenance Service</p></li>
                                <li><p class="mb-0">Technical Support in 24 hours online</p></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="card card-default box-shadow-8 border-radius-2 bg-light">
                    ...
                    <div id="collapseWhyChooseUsTwo" class="collapse"
                        ...
                        <div class="card-body pt-0">
                            <ul>
                                <li><p class="mb-0">One Door Solution for Window System</p></li>
                                <li><p class="mb-0">Free Consultant Service for Any Machines</p></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="card card-default box-shadow-8 border-radius-2 bg-light">
                    ...
                    <div id="collapseWhyChooseUsThree" class="collapse"
                        ...
                        <div class="card-body pt-0">
                            <div class="card-body pt-0">
                                <ul>
                                    <li><p class="mb-0">Supplier with 25 Years OEM Service</p></li>
                                    <li><p class="mb-0">Customized for Requirement</p></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-default box-shadow-8 border-radius-2 bg-light">
                    ...
                    <div id="collapseWhyChooseUsFour" class="collapse"
                        ...
                        <div class="card-body pt-0">
                            <ul>
                                <li><p class="mb-0">8S Management</p></li>
                                <li><p class="mb-0">Strict Monitoring and Testing</p></li>
                            </ul>
                        </div>
                    </div>
                </div>
