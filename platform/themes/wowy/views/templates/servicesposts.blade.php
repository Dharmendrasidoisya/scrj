...
{{-- @if ($category->activeChildrenparent->count()) --}}
         ...
         <div class="row mh-200px mh-lg-300px align-items-center py-4">
             <div class="col" style="text-align:center;">
                 <div class="appear-animation animated fadeInRightShorter appear-animation-visible"
                     ...
                     <span  class="badge bg-color-dark-rgba-30 text-light rounded-pill text-uppercase font-weight-semibold text-2-5 px-3 py-2 px-4 mb-3"><span
                 ...
                 <div class="appear-animation animated fadeIn appear-animation-visible" data-appear-animation="fadeIn"
                     ...
                     <ul class="breadcrumb d-flex text-3-5 font-weight-semi-bold pb-2 mb-3">
                         ...
                         <li class="active text-color-light opacity-7">{!! optional($servicescategories->first())->name !!}</li>
                     </ul>
                 </div>
             </div>
         </div>
                            ...
                            <div class="card rounded-3 border-0 bg-transparent box-shadow-10 box-shadow-1 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
                                <div class="p-relative rounded-3 overflow-hidden">
                                    <div class="card-body bg-light p-4">
                                        <h4 class="my-2">
                                            <a href="{{ Str::slug(str_replace('&', '', html_entity_decode($post->name))) }}" class="text-decoration-none text-dark text-color-hover-primary">
                                        ...
                                        <a href="{{ Str::slug(str_replace('&', '', html_entity_decode($post->name))) }}" class="read-more text-color-secondary font-weight-semibold text-2">
...
?>
@include(Theme::getThemeNamespace() . '::views.templates.servicespostsdeatils', compact('posts', 'servicescategories') )
