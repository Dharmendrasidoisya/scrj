             ...
             <div class="row mh-200px mh-lg-300px align-items-center py-4">
                 <div class="col lbtop" style="text-align:center;">
                     ...
                     <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
                         <h1 class="text-9 text-lg-12  font-weight-semibold line-height-1 mb-2">Blogs</h1>
                     </div>
                     <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
                         <ul class="breadcrumb d-flex text-3-5 font-weight-semi-bold pb-2 mb-3">
                             <li><a href="{{ BaseHelper::getHomepageUrl() }}"
                                     class=" text-decoration-none text-color-light">Home</a></li>
                             ...
                             <div
                                 ...
                                 <div class="p-relative rounded-3 overflow-hidden">
                                     ...
                                     <a href="{{ $post->url }}" class="text-decoration-none">
                                         <img class="card-img-top" src="{{ RvMedia::getImageUrl($post->image) }}"  style="height: 280px;" 
                                             alt="{{ $post->name }}" loading="lazy" alt="Common Tax Mistakes">
                                     </a>
                                     <div class="card-body bg-light p-4">
                                         <h4 class="my-2"><a href="{{ $post->url }}"
                                                 class="text-decoration-none text-dark text-color-hover-primary">{{ \Illuminate\Support\Str::limit($post->name, 38) }} </a>
                                         </h4>
