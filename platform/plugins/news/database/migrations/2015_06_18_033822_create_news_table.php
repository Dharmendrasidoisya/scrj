...
return new class () extends Migration {
    public function up(): void
    {
        ...
        Schema::create('newsposts_tags', function (Blueprint $table) {
            $table->foreignId('tag_id')->index();
            $table->foreignId('post_id')->index();
        });

        Schema::create('newsposts_categories', function (Blueprint $table) {
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('newsposts_tags');
        Schema::dropIfExists('newsposts_categories');
