...
class Post extends BaseModel
{
    ...
    {
        return $this->belongsToMany(Tag::class, 'newsposts_tags');
    }
    ...
    protected function firstCategory(): Attribute
    {
        return Attribute::get(function (): ?Category {
            $this->loadMissing('newscategories');

            return $this->newscategories->first();
        });
    }
    ...
    protected function timeReading(): Attribute
    {
        return Attribute::make(
            get: function (): string|null {
                ...
                return number_format(ceil(str_word_count(strip_newstags($this->content)) / 200));
            }
        );
    }
}
