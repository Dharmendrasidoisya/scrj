...
namespace Botble\News\Supports;
...
class FilterPost
{
    public static function setFilters(array $request): array
    {
        ...
        return [
            ...
            'newscategories' => $request['newscategories'] ?? null,
            'newscategories_exclude' => $request['newscategories_exclude'] ?? null,
            'newstags' => $request['newstags'] ?? null,
            'newstags_exclude' => $request['newstags_exclude'] ?? null,
