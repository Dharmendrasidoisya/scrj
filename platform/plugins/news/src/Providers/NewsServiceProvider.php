...
class NewsServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        SlugHelper::registerModule(Tag::class, 'News newstags');
        ...
        $this->app['events']->listen(ThemeRoutingBeforeEvent::class, function () {
            SiteMapManager::registerKey([
                'news-categories',
                'news-newstags',
                'news-posts-((?:19|20|21|22)\d{2})-(0?[1-9]|1[012])',
            ]);
        });
        ...
        DashboardMenu::default()->beforeRetrieving(function () {
            DashboardMenu::make()
                ...
                ->registerItem([
                    ...
                    'name' => 'Posts',
                    'route' => 'newsposts.index',
                ])
                ->registerItem([
                    'id' => 'cms-plugins-news-newscategories',
                    'priority' => 2,
                    'parent_id' => 'cms-plugins-news',
                    'name' => 'Categories',
                ...
                ->registerItem([
                    'id' => 'cms-plugins-news-newstags',
                    'priority' => 3,
                    'parent_id' => 'cms-plugins-news',
                    'name' => 'Tag',
                    'route' => 'newstags.index',
                ]);
        });
        ...
        PanelSectionManager::default()->beforeRendering(function () {
            PanelSectionManager::registerItem(
                ...
                fn () => PanelSectionItem::make('news')
                    ->setTitle(trans('plugins/news::base.settings.title'))
                    ->withIcon('ti ti-file-settings')
                    ->withDescription(trans('plugins/news::base.settings.description'))
                    ->withPriority(120)
                    ->withRoute('news.settings')
            );
        });
        ...
        if (defined('LANGUAGE_MODULE_SCREEN_NAME')) {
            if (
                ...
                $this->app['config']->get('plugins.news.general.use_language_v2')
            ) {
