    ...
    <form action="{{ route('whatsapp-floating-button.settings') }}" method="post">
        ...
        >
            ...
            <div class="whatsapp-floating-button-settings" data-bb-value="1" @style(['display: none' => ! setting('whatsapp-floating-button.enabled')])>
                ...
                />
                <x-core-setting::text-input
                :label="trans('plugins/whatsapp-floating-button::whatsapp-floating-button.email')"
                :value="setting('whatsapp-floating-button.email')"
                name="email"
               /> 
                ...
                <fieldset id="popup-settings" data-bb-value="1" @style(['display: none' => ! setting('whatsapp-floating-button.show_popup')])>
                    ...
                    />
                    <x-core-setting::textarea
                    :label="trans('plugins/whatsapp-floating-button::whatsapp-floating-button.role')"
                    :value="setting('whatsapp-floating-button.role')"
                    name="role"
                    />
                    <x-core-setting::text-input
                    :label="trans('plugins/whatsapp-floating-button::whatsapp-floating-button.compnyname')"
                    :value="setting('whatsapp-floating-button.compnyname')"
                    name="compnyname"
