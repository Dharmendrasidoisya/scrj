...
namespace Botble\Industry\Models;
...
class Post extends BaseModel
{
    ...
    protected static function booted(): void
    {
        static::deleted(function (Post $post) {
            $post->industrycategories()->detach();
    ...
    {
        return $this->belongsToMany(Tag::class, 'industryposts_tags');
    }

    public function industrycategories(): BelongsToMany
    {
    ...
    protected function firstCategory(): Attribute
    {
        return Attribute::get(function (): ?Category {
            $this->loadMissing('industrycategories');

            return $this->industrycategories->first();
        });
    }
    ...
    protected function timeReading(): Attribute
    {
        return Attribute::make(
            get: function (): string|null {
                ...
                return number_format(ceil(str_word_count(strip_industrytags($this->content)) / 200));
            }
        );
    }
}
