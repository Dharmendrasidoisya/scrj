...
class Category extends BaseModel implements HasTreeCategoryContract
{
    ...
    protected static function booted(): void
    {
        static::deleted(function (Category $category) {
            ...
            $category->industryposts()->detach();
        });
    }

    public function industryposts(): BelongsToMany
    {
    ...
    protected function badgeWithCount(): Attribute
    {
        return Attribute::get(function (): HtmlString {
            return Html::tag('span', sprintf('(%s)', $this->industryposts_count), [
                'data-bs-toggle' => 'tooltip',
                'data-bs-original-title' => trans('plugins/industry::categories.total_industryposts', ['total' => $this->industryposts_count]),
            ]);
        });
    }
}
